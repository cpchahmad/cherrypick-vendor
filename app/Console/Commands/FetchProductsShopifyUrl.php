...
class FetchProductsShopifyUrl extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'fetch:product-shopifyurl';
     ...
     * @var string
     */
    protected $description = 'Fetch Vendor Products';
    ...
    public function handle()
    {
        ...
        $vendor_data_count = VendorUrl::where('status','In-Progress')->count();
        if($vendor_data_count < 2) {
            $vendor_data = VendorUrl::where('status', 'In-Queue')->first();
