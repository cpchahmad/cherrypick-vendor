...
class approveProducts extends Command
{
    ...
    public function handle()
    {
        ...
        if($product_count > 0) {
            ...
            $product_data = Product::where('status', 1)->whereNull('shopify_id')->where('shopify_status', 'Pending')->chunk(20, function ($products,$log) {

                $products->update(['shopify_status'=>'In-Progress']);
              try {
