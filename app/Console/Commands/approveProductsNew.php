...
use App\Models\ProductVariantLog;
...
class approveProductsNew extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'products:approvenew';
    ...
    public function handle()
    {
        ...
        $logs=Log::where('name','Approve Product Push')->where('is_running',1)->where('running_at', '<=', $currentDatetime)->whereIn('status',['Processing','On-Hold'])->get();
