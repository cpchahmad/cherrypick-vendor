              ...
              <table class="table table-bordered datatable table-white">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Paid</td>
                    <td>₹ 634</td>
                    <td><span class="fulfill">Fulfilled</span></td>
                    <td><span class="en-in-progress"></span>New Order</td>
                  ...
                  <tr>
                    ...
                    <td>₹ 234</td>
                    <td><span class="fulfill">Fulfilled</span></td>
                    <td><span class="en-in-progress"></span>Ready for Pickup</td>
                    <td class="icon-action">
                        <a href="view-order.html"><i class="bi bi-eye"></i></a>
                  ...
                  <tr>
                    ...
                    <td>Unpaid</td>
                    <td>₹ 2324</td>
                    <td><span class="unfulfill">Unfulfilled</span></td>
                    <td><span class="en-dismissed"></span>Cancel</td>
                    <td class="icon-action">
                        <a href="view-order.html"><i class="bi bi-eye"></i></a>
                  ...
                  <tr>
                    ...
                    <td>Paid</td>
                    <td>₹ 1234</td>
                    <td><span class="fulfill">Partially Fulfilled</span></td>
                    <td><span class="en-recovered"></span>Completed</td>
                    <td class="icon-action">
                        <a href="view-order.html"><i class="bi bi-eye"></i></a>
