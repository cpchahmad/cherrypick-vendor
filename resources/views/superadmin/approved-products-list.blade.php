                         ...
                         @endphp
                          <tr>
                            ...
                            <td class="icon-action">
                                <a href="{{url('superadmin/products-details')}}/{{$row->id}}"><i class="bi bi-eye"></i></a>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
...
@endsection
 ...
 <script>
     ...
     function filterByVendor(id)
     {
          ...
          window.location.href=segment+'?search='+search+'&vendor='+id+'&date='+date;
     }
     function filterByName(val)
     {
         ...
         if(search!='')
         {
             ...
             var date='{{Request::get('date')}}';
             window.location.href=segment+'?search='+search+'&vendor='+vendor+'&date='+date;
         }
     }
     function filterByDate(val)
     {
         if(val!='')
         {
             var search='{{Request::get('search')}}';
             var vendor='{{Request::get('vendor')}}';
             window.location.href=segment+'?search='+search+'&venodr='+vendor+'&date='+val;
         }
     }
