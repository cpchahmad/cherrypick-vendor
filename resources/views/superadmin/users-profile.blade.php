        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{asset('uploads/superadminprofile/'.$data->profile_picture)}}" alt="Profile" class="rounded-circle">
              <h2>{{$data->name}}</h2>
              <h3>{{$data->job}}</h3>
            </div>
          </div>
                  ...
                  <form method="post" action="{{route('save-profile')}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{asset('uploads/superadminprofile/'.$data->profile_picture)}}" alt="Profile">
                        <label id="fileLabels"></label>
                        <div class="pt-2">
                          ...
                          <a href="{{route('remove-profile',$data->id)}}" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                        </div>
                      </div>
                    </div>
                   <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input  type="text" class="form-control" id="Job" value="{{$data->job}}" name="job">
                        <span style="color:red;">
                        @error('job')
                           {{$message}}
                       @enderror
